...
var photoSchema = new mongoose.Schema({
    ...
    likes: [mongoose.Schema.Types.ObjectId], // Array of users who liked the photo.
    viewableUsers: [mongoose.Schema.Types.ObjectId], // Array of users who can view the photo. mongoose.Schema.Types.ObjectId
});
